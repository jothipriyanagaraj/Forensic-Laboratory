				...
				<div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
					<nav class="menu menu--horatio">
						<ul class="nav navbar-nav menu__list">
							...
							<li class="menu__item"><a href="req_sent_to_admin.jsp" class="menu__link">Notifications()</a></li> 
							
							<li class="menu__item"><a href="patientinboxmessagess.jsp" class="menu__link">File Download</a></li> 
...
<div class="banner">
		...
		<div  id="top" class="callbacks_container">
			...
			<tr>
<th  align="center"><font color="#FF33E3" >Doctor</font></th>
<th  align="center">  <font color="#FF33E3" >file</font></th>
<th  align="center">  <font color="#FF33E3" >Encryption</font></th>
<th  align="center">  <font color="#FF33E3" >Prescription</font></th>
<th  align="center">  <font color="#FF33E3" >Patient</font></th>

<th  align="center">  <font color="#FF33E3" >REQUEST</font></th>
<!-- <th  align="center">     <font color="#FF33E3" >Encrypted</font></th>
<th  align="center">         <font color="#FF33E3" >Status</font></th> -->
   ...
   con=Regdbcon.CreateConnection();
	PreparedStatement ps1=con.prepareStatement("SELECT * FROM `doctorreg`.`doctershare` where patient='"+user+"'");
...
<%-- <td align="left"><%=mes%></td>
<td align="left"><%=mes1%></td>
 --%>


<td align="left"><a href="requestservlet?patientid=<%=user%>&&filename=<%=rs.getString(1)%>&&key=<%=rs.getString(3)%>"><button>Sent</button></a></td>
