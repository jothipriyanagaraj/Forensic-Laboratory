		...
		<div class="container ">
			...
			<div  id="top" class="callbacks_container">
				<ul class="rslides" id="slider3">
					<li>
<table  align="center" style="margin-top: 100px; width:50%;color:solid black">
			<tr>
<th  align="center">DOCTER NAME</th>
...
System.out.println("chjbshbsh"+user);
 ...
 String pat="";
   ...
   con=Regdbcon.CreateConnection();
	PreparedStatement ps1=con.prepareStatement("SELECT * FROM `doctorreg`.`message` where doctor='"+user+"'");
...
<td align="left"><a href="file_uploads.jsp?patient=<%=pat%>"><button>Reply</button></a></td>
