...
<div class="banner">
		...
		<div  id="top" class="callbacks_container">
			...
			<tr>
<th  align="center"><font color="red">FILENAME</font></th>
<th  align="center"><font color="red">DOCTOREMAIL</font></th>
<th  align="center"><font color="red">KEY</font></th>
<th  align="center"><font color="red">DOWNLOAD</font></th>
 ...
 HttpSession ses = request.getSession(true);
   ...
   con=Regdbcon.CreateConnection();
	PreparedStatement ps1=con.prepareStatement("SELECT * FROM doctorreg.request  where patient='"+user+"'");
	...
	<tr>
		<td align="left"><font color="red"><%=filename%></font></td>
<td align="left"><font color="red"><%=user%></font></td>

<td align="left"><font color="red"><%=key%></font></td>


<td align="left"><a href="Download?filename=<%=filename%>&&key=<%=key%>"><button><font color="red">download</font></button></a></td>
