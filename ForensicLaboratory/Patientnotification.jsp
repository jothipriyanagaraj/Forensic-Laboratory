...
<body>
  ...
  <a href="patient_mainpage.jsp">Home</a>
   ...
   <a href="doctor_notification.jsp">Notification()</a>
...
<th  align="center">File-encrypt</th>
<th  align="center">SEND</th>
   ...
   con=Regdbcon.CreateConnection();
	PreparedStatement ps1=con.prepareStatement("SELECT * FROM doctorreg.fileupload ");
...
<td align="left"><%=mes2%></td>
<td align="left"><a href="Share?file=<%=to%>&&size=<%=mes%>&&encrypt=<%=mes2%>"><button>send</button></a></td>
