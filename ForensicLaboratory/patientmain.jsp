				  ...
				  <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1">
					...
					<div class="logo grid">
						<div class="grid__item color-3">
							<h1><a class="link link--nukun" href="index.html"><i></i>ELECTRONIC<span>HEALTH</span>RECORD</a></h1>
						</div>
					</div>
				</div>
				...
				<div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
					<nav class="menu menu--horatio">
						...
						<li class="menu__item"><a href="doctordropdownlist.jsp" class="menu__link">Doctors List</a></li>
							...
							<li class="menu__item"><a href=patientinboxmessagess.jsp class="menu__link">FileDownload</a></li> 
					...
					<div class="banner1">
						<div class="container">
							<div class="banner-info">
								...
								<a href="searchjs.jsp" class="hvr-outline-out button2 scroll">Book an appointment</a>
							</div>
						</div>
					</div>
				</li> 
