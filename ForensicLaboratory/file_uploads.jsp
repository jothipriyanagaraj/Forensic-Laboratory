			...
			<div class="top-nav cl-effect-5">
				<ul class="nav1">
					...
					<li><a href="Doctor_notificationss.jsp"> <span data-hover="Inbox()">Inbox()</span></a></li>
						<li><a href="Doctorprescription.jsp"> <span data-hover="SHARE MEICINE()">SHARE </span></a></li>
...
<form action="Fileupload?user=<%=user%>&&p=<%=pat%>" method="post" enctype="multipart/form-data" >
							...
							<input type="file" name="filename" placeholder="choose file">	
								...
								<input type="text" name="key" value=<%=Secretkey%> placeholder="key">
