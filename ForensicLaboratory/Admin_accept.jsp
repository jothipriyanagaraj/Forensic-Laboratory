...
<th  align="center"><font color="red">DOCTOR EMAIL</font></th>
<th  align="center"><font color="red">FILE</font></th>
<th  align="center"><font color="red">KEY</font></th>
<th  align="center"><font color="red">ENCRYPT</font></th>
<th  align="center"><font color="red">SEND</font></th>
 ...
 String message="";
   ...
   con=Regdbcon.CreateConnection();
	PreparedStatement ps1=con.prepareStatement("SELECT * FROM `doctorreg`.`request");
   
	//PreparedStatement ps3=con.prepareStatement("SELECT * FROM `doctorreg`.`fileupload");
...
<td align="left"><a href="adminservlel?username=<%=user%>&&filename=<%=to%>&&key=<%=rs.getString(4)%>"><button>ACCEPT</button></a></td>
